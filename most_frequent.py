"""A baseline classifier that labels every instance as the most frequent class.
...
class MostFrequentClassifier(classification_method.ClassificationMethod):
    """The MostFrequentClassifier is a very simple classifier.

    For every test instance presented to it, the classifier returns
